...
namespace Application.FunctionalTests
{
    ...
    public partial class Testing
    {
        ...
        public static async Task<Guid?> RunAsUserAsync(string userName, string password, string[] roles)
        {
            ...
            var userManager = scope.ServiceProvider.GetRequiredService<UserManager<ApplicationUser<Guid>>>();

            var user = new ApplicationUser<Guid> { UserName = userName, Email = userName };
